...
public interface ResourceRequestRepository extends
    ...
    Flux<ResourceRequestPersistenceEntity> findAllByType(final ResourceRequestDomainModel.ResourceType type);

    // TODO: we need this because composite key still not suppoerted in Spring R2dbc
    Mono<ResourceRequestPersistenceEntity> findByTypeAndId(final ResourceRequestDomainModel.ResourceType type, final long id);
    ...
    Mono<Integer> updateStatus(
            @Param("type") final ResourceRequestDomainModel.ResourceType type,
